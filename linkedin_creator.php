                ...
                <div class="centrize full-width">
                    <div class="vertical-center">
                        <div class="started-content">
                            <h1 class="h-title">LINKEDIN CREATOR</h1>
                            ...
                            <div class="single-post-text">
                                <div class="portfolio-info portfolio-cols">
                                    <div class="description-col"style="text-align: justify;">
                                        ...
                                        <p>In March 2020 - I joined LinkedIn and boom - what a journey it has been! With over 32,000 followers now, I am one of the top content creators on the platform and was selected to be a part of their prestigious creator accelerator program where I launched a project to support more women-led businesses in India. You can follow me on the linkedin through the link below:
                            
                                        </p>
                                        <!--<br>
                                        -Spearheaded the UNYI Mission 75 officially registered under the UN75.<br>
        -Selected as the National Speaker at the National Dialogue sessions attended by 75+ youth leaders.<br>
        -Managed collaborations for the United Climate front attended by 30+ global and national climate activists.<br>
        -Selected as the Member of the Jury for the Youth Spark Ideathon to devise practical solutions to ensure uninterrupted education to children amidst the covid-19 pandemic.
-->
                                    </div>
                                    
                                </div>
                            </div>
                            <div class="post-text-bottom"></div>
                        </div>
                    </div>
                    <div class="clear"></div>
                </div>
