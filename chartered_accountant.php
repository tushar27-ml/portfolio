                ...
                <div class="centrize full-width">
                    <div class="vertical-center">
                        <div class="started-content">
                            <h1 class="h-title">CHARTERED ACCOUNTANT </h1>
                            ...
                            <div class="single-post-text">
                                <div class="portfolio-info portfolio-cols">
                                    <div class="description-col"style="text-align: justify;">
                                        ...
                                        <p>
                                        I am a Chartered Accountant by qualification who is currently working in the Consulting domain with a global consulting firm. Till date, I have mentored several students on a host of topics such as acing the CA examinations, career planning networking, profile building through personal interactions, guest lectures at top colleges and in association with platforms like Unacademy. If you would love to connect with me to discuss the same, please head to the contact section! 
                                        </p>
                                        <img class="jarallax-img"
                        src="img/CA_2.JPG" alt="">
