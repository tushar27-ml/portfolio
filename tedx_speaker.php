                ...
                <div class="centrize full-width">
                    <div class="vertical-center">
                        <div class="started-content">
                            <h1 class="h-title">TEDX SPEAKER</h1>
                            ...
                            <div class="single-post-text">
                                <div class="portfolio-info portfolio-cols">
                                    <div class="description-col"style="text-align: justify;">
                                        ...
                                        <p>I have delivered TEDx talks on a host of different topics such as sports, sustainability, personal development, gender equality etc. You can find the links to my TEDx talks below: 
                                        <br>
                                         Links will be update later.
                                        </p>
                                        <img class="jarallax-img"
                        src="img/TED_2.jpg" alt="">
                                        <!--<br>
