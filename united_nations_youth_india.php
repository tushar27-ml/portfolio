                ...
                <div class="centrize full-width">
                    <div class="vertical-center">
                        <div class="started-content">
                            <h1 class="h-title">UN WOMEN INDIA</h1>
                            ...
                            <div class="single-post-text">
                                <div class="portfolio-info portfolio-cols">
                                    <div class="description-col"style="text-align: justify;">
                                        ...
                                        <p>I was invited by UN Women India as one of the eight allies to spearhead the generation equality campaign. As a part of this campaign I work on creating awareness and resolving issues relating to girl education, period taboo, women social and economic empowerment.
                                        </p>
                                        <img class="jarallax-img"
                        src="img/UN_2.JPG" alt="">
                                        <!--<br>
